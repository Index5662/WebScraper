...
while i <= 14:                  #change 0 to number of loops you want +1 and pages to go through
 i = i + 1   
 print(i)
 time.sleep(1800)              #time delay in seconds

 response = requests.get("https://auctions.britishmedicalauctions.co.uk/auctions/catalog/id/498/June-2022-Two-Day-Live-Medical-Equipment-Auction?page=" + str(i))              #link to direct bids auction
