...
while i <= 0:           #0 = number of loops +1  or  #0 = number of pages +1
 ...
 response = requests.get("https://www.proxibid.com/Bond-Bond-Auctioneers-LLC/GOV-SCHOOL-DISTRICT-SURPLUS-CONSIGNMENTS/event-catalog/223067?p=3&sort=0#cnTb" + """str(i)""")              #link to direct bids auction
